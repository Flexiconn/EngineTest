...
void  Render::SetUp(GLFWwindow* newWindow) {
   ...
   // ------------------------------
    ...
    // ------------------------------------
    ourShader = new Shader("default.vert", "default.frag");

    // set up vertex data (and buffer(s)) and configure vertex attributes
    // ------------------------------------------------------------------

    // world space positions of our cubes
    ImageToVertexArray tt;
    float * rr = tt.ToArray("test");
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(rr), rr, GL_DYNAMIC_DRAW);
    ...
    Image image = load_image("test.png");
...
void Render::RenderFrame(std::vector<GameObject*> objects)
{
    // render loop
    // -----------
        ...
        {
            struct XYZ pos = objects[i]->GetPosition();
            struct XYZ scale = objects[i]->GetScale();
            struct XYZ rot = objects[i]->GetRotation();
